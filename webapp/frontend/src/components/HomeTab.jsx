        ...
        >
            {logs.map((log) => (
                <motion.div
                    ...
                    className={`
            group relative bg-white p-5 rounded-[1.25rem] border border-slate-100 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)] 
            hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 cursor-pointer
                ...
                >
                    <div className="flex justify-between items-start mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">{log.time}</span>
                        </div>
              ...
              ${log.emotion === 'Happy'
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1">
                            <h3 className="font-bold text-slate-800 text-lg mb-1 group-hover:text-indigo-600 transition-colors">{log.type}</h3>
                            <p className="text-slate-500 text-sm line-clamp-2 leading-relaxed">{log.details}</p>
                        </div>
